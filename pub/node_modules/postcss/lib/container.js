...
var _warnOnce = require('node_modules/postcss/lib/warn-once');
...
var _node = require('node_modules/postcss/lib/node');
...
var Container = function (_Node) {
    ...
    Container.prototype.normalize = function normalize(nodes, sample) {
        ...
        if (typeof nodes === 'string') {
            var parse = require('node_modules/postcss/lib/parse');
            ...
            if (nodes.type === 'root') {
                ...
                var Rule = require('node_modules/postcss/lib/rule');
                nodes = [new Rule(nodes)];
            } else if (nodes.name) {
                var AtRule = require('node_modules/postcss/lib/at-rule');
    ...
    Container.prototype.rebuild = function rebuild(node, parent) {
        ...
        var fix = void 0;
        if (node.type === 'root') {
            var Root = require('node_modules/postcss/lib/root');
            fix = new Root();
