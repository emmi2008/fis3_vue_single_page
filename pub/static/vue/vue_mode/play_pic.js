...
exports["default"] = {
    ...
    watch: {
        ...
        "current_pos": function current_pos() {
            var self = this;
            if (self.current_pos < 0) self.current_pos = 0;else if (self.current_pos > self.count - 1) {
